/**
 * Complete dictionary of ALL BEI (IDX) stock tickers -> cleaned company names.
 * Source: Wikipedia Indonesia (941 companies listed on BEI as of Dec 2024).
 * Used for instant local lookup (no network round-trip) across ticker search,
 * calculator forms, market summary top movers, and any module that needs
 * to resolve a symbol to a name.
 *
...
AYLS: "Arkayana Lestari Grup Tbk",
...
ICON: "Island Conces Indonesia Tbk",
...
NATO: "Olympus Strategic Indonesia Tbk",
...
OPMS: "Oima Prima Metal Sinergi Tbk",
...
SAGE: "Saausaha Gemilangindah Tbk",
